        ...
        AmsifySuggestags.prototype = {
            ...
            setIcon : function() {
              ...
              if(settings.type == 'bootstrap') {
                return '<button aria-label="Close" tabindex="1" type="button" class="close material-icons right '+removeClass+'" style="white-space: nowrap; font-size: 1.5em;  line-height: 0.9em;"><span aria-hidden="true">×</span></button>';
