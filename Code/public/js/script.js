    ...
    function setCountryToSelect(countryToSelect) {
        ...
        geocoder.geocode( { 'address': countryToSelect}, function(results, status) {
            if (status == google.maps.GeocoderStatus.OK) {
               ...
               var addresses = ['aha personal ag, Igelweid 18, 5000 Aarau, Schweiz', 'aha personal ag, Zentralstrasse 7, 6003 Luzern, Schweiz', 
                                'aha personal ag, Schaffhauserstrasse 239, 8057 Zürich, Schweiz'];
