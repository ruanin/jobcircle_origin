...
<div class="container">
    ...
    <p>Als Kunde oder Bewerber merken Sie sofort, dass wir ein TEAM mit gemeinsamen Zielen sind, das sich in Ihrer Branche bestens auskennt. Unsere Kompetenz ist Ihr Gewinn. Die Personalberater von Brefis sind ausgewiesene Fachleute und besitzen Erfahrungen auf dem lokalen Arbeitsmarkt. Sie verfügen über fundierte Erfahrungen in der Baubranche und im Personalbereich uns wissen, worauf es ankommt. Dank dieser Kompetenzen können wir alle Positionen mit den geeigneten Mitarbeitern besetzen und stärken dadurch deren Motivation. </p>
    <p>Bei Brefis behandeln wir Menschen nicht wie Nummern sondern als wertvolle Mitarbeitende mit individuellen Fähigkeiten. Unsere Temporärmitarbeiter erkennen, dass ihrer Arbeit geschätzt wird und dass wir ihre Belange und Anliegen verstehen. Alle Temporärmitarbeiter, die wir an unsere Kunden vermitteln, werden dem betreffenden Unternehmen und dem zuständigen Personalberater in einem Vorstellungsgespräch ausführlich vorgestellt. So wird ein Vertrauensverhältnis begründet, das die Zuverlässigkeit und Motivation von Arbeitgeber und Arbeitnehmer deutlich erhöht. Gutes Geld für gute Arbeit! Dies schafft eine besonders hohe Kundenzufriedenheit, die wir letztlich anstreben. Brefis schafft die Basis für Ihren Erfolg.</p>
    <hr>
