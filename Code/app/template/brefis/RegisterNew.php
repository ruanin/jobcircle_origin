...
<div class="document-breadcrumb" style="margin-bottom:10px;">
    <div class="container">
        <ul class="breadcrumb">
            <li><a href="#">Home</a></li>
...
<div class="container">
    <div class="row">	
        <div class="col-md-12 none-padding">
            ...
            ?>
            <form id="register-wizard" action="/Candidate/registerWizard" enctype="multipart/form-data" class="form-horizontal" method="POST">
                        ...
                        <div class="panel-group" id="1">
                            <div class="panel panel-default panel-faq">
                                ...
                                <div id="section1" class="panel-collapse collapse">
                                    <div class="panel-body">	
                                        <p>Bitte geben Sie Ihre Handynummer ein und klicken Sie auf Weiter. Sie dient als Benutzername für Ihr neues my brefis Konto.Anschliessend erhalten Sie einen Code per SMS.</p>
                            ...
                            <div class="panel panel-default panel-faq">
                                ...
                                <div id="section2" class="panel-collapse in">
                                    <div class="panel-body">
                                        <p>
                                            Bitte geben Sie Ihre E-Mail-Adresse ein und klicken Sie auf Weiter. Sie dient als Benutzername für Ihr neues my brefis Konto.
                                        </p>
                                        <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input class="form-control" id="birthday" name="birthday" value="" type="text" required/>
                                    <script type="text/javascript">
                                        $(function () {
                                            var minDate = new Date('<?=date('Y',strtotime('-16 years',time()))?>','<?=date('m',strtotime('-16 years',time()))?>','<?=date('d',strtotime('-16 years',time()))?>');
                                            var maxDate = new Date('<?=date('Y',strtotime('-90 years',time()))?>','<?=date('m',strtotime('-90 years',time()))?>','<?=date('d',strtotime('-90 years',time()))?>');
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">		
                                            <input type="file" name="cvfile" id="cv-register" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-9">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">		
                                            <input type="file" name="userfile1" id="file" />  
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="file2" class="col-sm-2 control-label">
                                            Anhang:
                                        </label>	
                                        <div class="col-sm-10">		
                                    ...
                                    <div class="form-group">
                                        <label for="file3" class="col-sm-2 control-label">
                                            Anhang:
                                        </label>	
                                        <div class="col-sm-10">		
                                            <input type="file" name="userfile3" id="file3" />  
                                        </div>
                                    </div>
                                </div>
                            </div>
