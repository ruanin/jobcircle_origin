                        ...
                        <div class="box-wrapper white-container">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <tbody>
                                       <?php foreach($data['payrollFiles'] as $year => $yearData){ 
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$arrFileName[6]?></td>
                                            <td><?=$arrFileName[5]?></td>
                                            <td class="center"><?php if(preg_match('~MSIE|Internet Explorer~i', $_SERVER['HTTP_USER_AGENT']) || (strpos($_SERVER['HTTP_USER_AGENT'], 'Trident/7.0; rv:11.0') !== false)){ ?><a href="<?=WEB_URL?>/Candidate/viewPayRollFile?fileName=<?=$fileData['filename']?>.<?=$fileData['extension']?>" target="_blank" class="center" style="target-new: tab;" title="Vertrag <?=$arrFileName[5]?>: Lohnabrechnung <?=$arrFileName[6]?> <?=$arrFileName[7]?>">Öffnen</a> <?php }else{ ?><a href="<?=WEB_URL?>/Candidate/viewPayRollFile?fileName=<?=$fileData['filename']?>.<?=$fileData['extension']?>&keepThis=true&TB_iframe=true&height=800&width=900" title="Vertrag <?=$arrFileName[5]?>: Lohnabrechnung <?=$arrFileName[6]?> <?=$arrFileName[7]?>" class="center thickbox">Öffnen</a> <?php } ?>| <a href="<?=WEB_URL?>/Candidate/viewPayRollFile?fileName=<?=$fileData['filename']?>.<?=$fileData['extension']?>&fileDownload=1" class="center" title="Vertrag <?=$arrFileName[5]?>: Lohnabrechnung <?=$arrFileName[6]?> <?=$arrFileName[7]?>">Download</a></td>
                                        </tr>
                                    ...
                                    <?php }else{ ?>
                                    <p class="bg-info" style="padding: 15px;"><strong>Es sind keine Lohnabrechnungen vorhanden!</strong></p>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
