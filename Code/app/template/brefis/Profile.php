            ...
            <div id="Profile">
                <ul class="resp-tabs-list hor_1">
                    ...
                    <?php if (isset($_SESSION['cand_profile_id']) && !empty($_SESSION['cand_profile_id'])) { ?>
                        ...
                        <li>Zusätzliche Angaben</li>
                        <li>Mein Lebenslauf</li>
                        <li>Meine Anhänge</li>
                    <?php } ?>
                </ul>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label">Anrede:<span
                                                            class="star">&nbsp;*</span></label>
                                                <div class="col-sm-8">
                                                    <select name="salutation" style="width: auto!important"
                                                            class="form-control" <?= !empty($data['profile_form']['hrc_cand_accounting_number']) && !empty($data['profile_form']['hrc_cand_id']) ? 'disabled' : '' ?>
                                                            required>
                                                        <?php
                                                        $m = $w = '';
                                            ...
                                            <div class="form-group">
                                                <label for="firstname" class="col-sm-4 control-label">Vorname:<span
                                                            class="star">&nbsp;*</span></label>
                                                <div class="col-sm-8">
                                                    <input class="form-control" id="firstname" name="firstname"
                                                           placeholder="Vorname"
                                                           value='<?= $data['profile_form']['f_name'] ?>'
                                                           type="text" <?= !empty($data['profile_form']['hrc_cand_accounting_number']) && !empty($data['profile_form']['hrc_cand_id']) ? 'disabled' : '' ?>
                                                           required/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="lastname" class="col-sm-4 control-label">Nachname:<span
                                                            class="star">&nbsp;*</span></label>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input class="form-control" id="birthday" name="birthday"
                                                           value="<?= date('d.m.Y', strtotime($data['profile_form']['birthday'])) ?>"
                                                           type="text" <?= !empty($data['profile_form']['hrc_cand_accounting_number']) && !empty($data['profile_form']['hrc_cand_id']) ? 'disabled' : '' ?>
                                                           required/>
                                                    <script type="text/javascript">
                                                        $(document).ready(function () {
                                            ...
                                            <div class="form-group">
                                                <label for="ahv-number" class="col-sm-4 control-label">AHV
                                                    Nummer:</label>
                                                <div class="col-sm-8">
                                                    <input class="form-control" id="ahv-number" name="ahv-number"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input class="form-control" id="street" name="street"
                                                           value="<?= $data['profile_form']['street'] ?>" size="30"
                                                           placeholder="Strasse / Nr." type="text" required/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input class="form-control" id="city" name="city"
                                                           value="<?= $data['profile_form']['city'] ?>" size="30"
                                                           placeholder="Ort" type="text" required/>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group pull-right" style="padding-right:15px;">
                                                <button class="btn btn-secondary validate subbtn" type="submit">
                                                    Speichern
                                                </button>
                                                <button class="btn btn-secondary validate subbtn" type="button">
                                                    Abbrechen
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <form class="form-horizontal" name="register" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" id="phone" name="phone"
                                                       value="<?= $data['profile_form']['phone'] ?>" size="30"
                                                       placeholder="Festnetz" type="text"/>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" id="mobile" name="mobile"
                                                       value="<?= $data['profile_form']['mobile'] ?>" size="30"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input class="form-control" id="email" name="mail"
                                                       value="<?= $data['profile_form']['mail'] ?>" size="30"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group pull-right none-padding" style="padding-right:15px;">
                                                    <button class="btn btn-secondary validate subbtn" type="submit">
                                                        Speichern
                                                    </button>
                                                    <button class="btn btn-secondary validate subbtn" type="button">
                                ...
                                <div class="col-md-12">
                                    <form class="form-horizontal" name="register" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group pull-right none-padding"
                                    ...
                                    <div class="col-md-12">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group pull-right none-padding"
                                                    ...
                                                    <button class="btn btn-secondary pull-right"
                                                            style="margin-top:0px !important;" type="submit">Speichern
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <?php if (!empty($data['cvfiles'])) {
                                                for ($i = 0; $i < count($data['cvfiles']); $i++) {
                                                    ?>
                                                    <div class="col-md-8">
                                                        <div class="col-sm-11">
                                                            <?= $data['cvfiles'][$i]['basename'] ?>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group pull-right none-padding"
                                                     style="padding-right:15px;">
                                                    <button class="btn btn-secondary pull-right subbtn"
                                                            style="margin-top:0px !important;" type="submit">Speichern
                                                    </button>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <?php if (!empty($data['attachements'])) {
                                                for ($i = 0; $i < count($data['attachements']); $i++) {
                                                    ?>
                                                    <div class="col-md-8">
                                                        <div class="col-sm-11">
                                                            <?= $data['attachements'][$i]['basename'] ?>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="col-sm-12 pull-right"
                                                            ...
                                                            <?php if (preg_match('~MSIE|Internet Explorer~i', $_SERVER['HTTP_USER_AGENT']) || (strpos($_SERVER['HTTP_USER_AGENT'], 'Trident/7.0; rv:11.0') !== false)) { ?>
                                                                ...
                                                                class="thickbox">Öffnen</a> <?php } ?>| <a
                                                                    ...
                                                                    title="Anhang <?= $data['attachements'][$i]['basename'] ?>">Download</a>
                                                        </div>
                                                    </div>
                                                    <?php
                                                }
