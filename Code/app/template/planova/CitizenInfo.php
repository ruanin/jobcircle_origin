    ...
    <div class="box-wrapper page-content">
        <div class="row">
            <div class=" col-lg-5 col-md-5 col-sm-12 col-xs-12">
                <div class="thumb">	
                    <img alt="Arbeiten in der Schweiz" class="img-responsive" src="<?=WEB_URL?>/tmpl_planova/img/arbeiten_in_der_schweiz.jpg" />
                </div>
            </div>
            <div class=" col-lg-7 col-md-7 col-sm-12 col-xs-12">
                <div class="thumb">						
                    <div style="border-bottom: 1px solid #dddddd; padding-bottom: 5px;">
                        <h2>Infos für EU-Bürger</h2>
                        <h4>Werden Sie Teil unseres Netzwerkes, Teil eines starken Teams</h4>
                        <p style="text-align: justify;">
                        Die Schweiz bietet für viele Menschen eine Perspektive. Wir haben zahllose Beispiele, wie Sie erfolgreich in einem der schönsten Länder dieser Welt Ihren Beruf ausüben können. planova sucht gezielt EU-Bürger mit Erfahrung in den Kernbereichen (Bau/Ausbau und Industrie). Wenn Sie eine neue Herausforderung suchen wir eine zu Ihrem Profil passende Stelle.
                        </p>
                    </div>

                    <p style="margin-top: 10px; text-align: justify;">Benötigen Sie zusätzliche Informationen über Arbeitsmöglichkeiten in der Schweiz? 
                    Zum Beispiel in Bezug auf Aufenthalts- und Arbeitsbewilligungen, Quellensteuer oder Krankenversicherung? Unserer Fachleute sind auf solche Fragen spezialisiert und kümmern sich um die Fragen und Belange unserer ausländischen Temporärarbeiter. Ob Behördengänge, Anmeldungen, Unterbringung oder Wohnung: wir helfen Ihnen gerne.
                    </p>

                    <h4 style="text-align: center;">Hier können Sie Ihre Fragen stellen oder um einen Rückruf bitten:</h4>
                    <p style="text-align: center" style="margin-top: 11px;">
                        <a href="#fragen-formular" class="btn btn-primary" type="submit">FRAGEN SIE UNS!</a>
                    </p>
                </div>
            </div>				
        </div>
...
<div class="container mt-15">
    <div class="box-wrapper page-content">
        <div class="row">          
            <div class=" col-lg-5 col-md-5 col-sm-12 col-xs-12">
                <div class="thumb">						
                    <h2>Die meistgesuchten Berufe in der Baubranche</h2>
                    <p style="text-align: justify;">
                    Im schweizerischen Bausektor sind mehr als 80’000 Personen beschäftigt. Es bestehen Engpässe vor allem beim Kaderpersonal aber auch qualifizierte Fachleute sind gesucht.
                    </p>
                    <div style="margin-left:25px;">
                        <ul class="list-style">
                            <div style='width:50%;float:left'>
                                <li><i class="fa fa-angle-right"></i>Bauführer</li>
                                <li><i class="fa fa-angle-right"></i>Baumaschinenführer</li>
                                <li><i class="fa fa-angle-right"></i>Gipser</li>                          
                                <li><i class="fa fa-angle-right"></i>Maurer</li> 
                                <li><i class="fa fa-angle-right"></i>Sanitärmonteur</li>
                                <li><i class="fa fa-angle-right"></i>Schreiner</li>
                                <li><i class="fa fa-angle-right"></i>Strassenbauer</li>
                            </div>
                            <div style='width:50%;float:right'>
                                <li><i class="fa fa-angle-right"></i>Polier</li>
                                <li><i class="fa fa-angle-right"></i>Elektroinstallateur</li>
                                <li><i class="fa fa-angle-right"></i>Maler</li>
                                <li><i class="fa fa-angle-right"></i>Plattenleger</li>
                                <li><i class="fa fa-angle-right"></i>Schaler</li>
                                <li><i class="fa fa-angle-right"></i>Zimmermann</li>                
                            </div>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-lg-7 col-md-7 col-sm-12 col-xs-12">
                <div class="thumb">	
                    <iframe width="640" height="360" src="https://www.youtube.com/embed/JFR5JEFJnSM?rel=0&amp;controls=0&amp;showinfo=0" frameborder="0" style="width:100%;" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="box-wrapper">						
                <div class="single-page-item typography">
                    <h2>Vor der Einreise</h2>
                    <div style="margin-top: 20px; margin-bottom: 40px;">
                        <div class="panel-group" id="1">
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#1" href="#section1">
                            ...
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#1" href="#section2">
                                        <h4 class="panel-title">
                                ...
                                <div id="section2" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <p style="text-align: justify;">
                                        Die planova human capital ag kümmert sich auf Wunsch vor Ihrem Arbeitsbeginn um eine angemessene Unterkunft in einem Hotel oder einer Pension.
                            ...
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#1" href="#section3">
                                        <h4 class="panel-title">
                            ...
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#1" href="#section4">
                                        <h4 class="panel-title">
                                            Fahrzeugimport
                                        </h4>
                                    </a>
                                ...
                                <div id="section4" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        ...
                                        <div style=" margin-left:25px;">
                                            <ul class="list-style">
                                                <li><i class="fa fa-angle-right"></i> Derjenige, der das Kraftfahrzeug einführen will, muss mindestens sechs Monate der Halter des Fahrzeuges gewesen sein.</li>
                                                <li><i class="fa fa-angle-right"></i> Derjenige, der das Kraftfahrzeug einführen will, darf in den kommenden zwölf Monaten das Auto nicht an Dritte verleihen oder verkaufen.</li>
                                                <li><i class="fa fa-angle-right"></i> Wird eine dieser Bedingungen nicht erfüllt, sind auf das Fahrzeug Abgaben zu entrichten, auch nachträglich.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <h2>Bewilligungen</h2>
                    <div style="margin-top: 20px; margin-bottom: 40px;">
                        <div class="panel-group" id="2">
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#2" href="#2section1">
                                        <h4 class="panel-title">
                                            Über Bewilligung und Pflichten
                                        </h4>
                                    </a>
                                </div>

                                <div id="2section1" class="panel-collapse collapse">
                                    <div class="panel-body">														                         
                                        <p style="text-align: justify;">
                                        ...
                                        <div style=" margin-left:25px;">
                                            <ul class="list-style">
                                                <li><i class="fa fa-angle-right"></i> geografische und berufliche Mobilität (d.h. Sie können jederzeit den Wohnort und die Arbeitsstätte wechseln)</li>
                                                <li><i class="fa fa-angle-right"></i> gleiche Arbeitsbedingungen</li>
                                                <li><i class="fa fa-angle-right"></i> Sozialversicherungsschutz</li>
                                                <li><i class="fa fa-angle-right"></i> gleiche soziale Unterstützung</li>
                                                <li><i class="fa fa-angle-right"></i> gleiche steuerliche Pflichten und Vergünstigungen</li>
                                                <li><i class="fa fa-angle-right"></i> gegenseitige Anerkennung von Abschlüssen im Hinblick auf die Zulassung zu einer reglementierten Erwerbstätigkeit. </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#2" href="#2section2">
                                        <h4 class="panel-title">
                                            Meldepflicht
                                        </h4>
                                    </a>
                                ...
                                <div id="2section2" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <p style="text-align: justify;">
                            ...
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#2" href="#2section3">
                                        <h4 class="panel-title">
                                            Meldeverfahren für eine max. 90-tägige Erwerbstätigkeit
                                        </h4>
                                    </a>
                                </div>

                                <div id="2section3" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <p style="text-align: justify;">
                            ...
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#2" href="#2section4">
                                        <h4 class="panel-title">
                                            Führerschein
                                        </h4>
                                    </a>
                                ...
                                <div id="2section4" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <p style="text-align: justify;">
                    ...
                    <h2>Aufenthaltsbewilligungen</h2>
                    <div style="margin-top: 20px; margin-bottom: 40px;">
                        <div class="panel-group" id="3">
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#3" href="#3section1">
                                        <h4 class="panel-title">
                                            Aufenthaltsbewilligung für eine mehr als 90-tägige Erwerbstätigkeit
                                        </h4>
                                    </a>
                                </div>

                                <div id="3section1" class="panel-collapse collapse">
                                    <div class="panel-body">														                         
                                        <p style="text-align: justify;">
                            ...
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#3" href="#3section2">
                                        <h4 class="panel-title">
                                ...
                                <div id="3section2" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <p style="text-align: justify;">
                                        ...
                                        <div class="example">
                                            <table class="table table-bordered">
                                                <tbody>
                                                    <tr>
                                                        <td><img alt="Ausweis Grenzgängerbewilligung" src="<?=WEB_URL?>/tmpl_planova/img/ausweis_grenzgaenger_temporaer.png"></td>
                                                    ...
                                                    <tr>
                                                        <td><img alt="Ausweis Kurzaufenthaltsbewilligung" src="<?=WEB_URL?>/tmpl_planova/img/ausweis_kurzaufenthalt_temporaer.png"></td>
                                                        <td style="vertical-align: middle; padding: 20px;">
                                                    ...
                                                    <tr>
                                                        <td><img alt="Ausweis Jahresaufenthaltsbewilligung" src="<?=WEB_URL?>/tmpl_planova/img/ausweis_jahresaufenthalt_mitarbeiter.png"></td>
                                                        <td style="vertical-align: middle; padding: 20px;">
                                                    ...
                                                    <tr>
                                                        <td><img alt="Ausweis Niederlassungsbewilligung" src="<?=WEB_URL?>/tmpl_planova/img/ausweis_niederlassung_mitarbeiter.png"></td>
                                                        <td style="vertical-align: middle; padding: 20px;">
                    ...
                    <div style="margin-top: 20px; margin-bottom: 40px;">
                        <div class="panel-group" id="4">
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#4" href="#4section1">
                                        <h4 class="panel-title">
                                            Sozialabgaben
                                        </h4>
                                    </a>
                                ...
                                <div id="4section1" class="panel-collapse collapse">
                                    <div class="panel-body">														                         
                                        <p style="text-align: justify;">
                                        ...
                                        <div style=" margin-left:25px;">
                                            <ul class="list-style">
                                                <li><i class="fa fa-angle-right"></i> Invalidität</li>
                                                <li><i class="fa fa-angle-right"></i> Alter einschliesslich Leistungen für Hinterbliebene und Arbeitslosigkeit</li> 
                                                <li><i class="fa fa-angle-right"></i> Unfall und Pensionskasse</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#4" href="#4section2">
                                        <h4 class="panel-title">
                                ...
                                <div id="4section2" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <p style="text-align: justify;">
                            ...
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#4" href="#4section3">
                                        <h4 class="panel-title">
                                            Krankenkasse
                                        </h4>
                                    </a>
                                ...
                                <div id="4section3" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <p style="text-align: justify;">
                            ...
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#4" href="#4section4">
                                        <h4 class="panel-title">
                                            ALV
                                        </h4>
                                    </a>
                                ...
                                <div id="4section4" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <p style="text-align: justify;">
                            ...
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#4" href="#4section5">
                                        <h4 class="panel-title">
                                            Unfallversicherung
                                        </h4>
                                    </a>
                                ...
                                <div id="4section5" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <p style="text-align: justify;">
                            ...
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#4" href="#4section6">
                                        <h4 class="panel-title">
                                ...
                                <div id="4section6" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <p style="text-align: justify;">
                            ...
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#4" href="#4section7">
                                        <h4 class="panel-title">
                                ...
                                <div id="4section7" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <p style="text-align: justify;">
                            ...
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#4" href="#4section8">
                                        <h4 class="panel-title">
                                ...
                                <div id="4section8" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <p style="text-align: justify;">
                            ...
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#4" href="#4section9">
                                        <h4 class="panel-title">
                                ...
                                <div id="4section9" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <p style="text-align: justify;">
                            ...
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#4" href="#4section10">
                                        <h4 class="panel-title">
                                            Familiennachzug
                                        </h4>
                                    </a>
                                ...
                                <div id="4section10" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <p style="text-align: justify;">
                            ...
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#4" href="#4section11">
                                        <h4 class="panel-title">
                                            Sprachkenntnisse
                                        </h4>
                                    </a>
                                ...
                                <div id="4section11" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <p style="text-align: justify;">
                    ...
                    <h2>Kinder</h2>
                    <div style="margin-top: 20px; margin-bottom: 40px;">
                        <div class="panel-group" id="5">
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#5" href="#5section1">
                                        <h4 class="panel-title">
                                ...
                                <div id="5section1" class="panel-collapse collapse">
                                    <div class="panel-body">														                         
                                        <p style="text-align: justify;">
                            ...
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#5" href="#5section2">
                                        <h4 class="panel-title">
                                            Kinderzulagen
                                        </h4>
                                    </a>
                                ...
                                <div id="5section2" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <p style="text-align: justify;">
                            ...
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#5" href="#5section3">
                                        <h4 class="panel-title">
                                            Kinderbetreuung
                                        </h4>
                                    </a>
                                ...
                                <div id="5section3" class="panel-collapse collapse">
                                    <div class="panel-body">
                            ...
                            <div class="panel panel-default panel-faq">
                                <div class="panel-heading">
                                    <a data-toggle="collapse" data-parent="#5" href="#5section4">
                                        <h4 class="panel-title">
                                ...
                                <div id="5section4" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <p style="text-align: justify;">
                                        ...
                                        <div style=" margin-left:25px;">
                                            <ul class="list-style">
                                                <li><i class="fa fa-angle-right"></i> <strong>Zweijährige Grundbildung:</strong> Die zweijährige Grundbildung ersetzt die bisherige Anlehre (siehe <a href="https://de.wikipedia.org/wiki/Anlehre" target="_blank"><strong>de.wikipedia.org/wiki/Anlehre</strong></a>) und wird mit einem eidgenössischen Berufsattest abgeschlossen.</li>
                                                <li><i class="fa fa-angle-right"></i> <strong>Drei- oder vierjährige Grundbildung:</strong> Die drei- oder vierjährige Grundbildung dient der Vorbereitung auf die Ausübung eines Berufs und schliesst mit einem eidgenössischen Fähigkeitszeugnis ab. Hierfür stehen über 200 Lehrberufe zur Auswahl.</li>
                                                <li><i class="fa fa-angle-right"></i> <strong>Berufsmaturität:</strong> Zur Ergänzung der drei- oder vierjährigen beruflichen Grundbildung steht die Berufsmaturität. Sie kann sowohl parallel zur beruflichen Grundbildung oder nach einer abgeschlossenen beruflichen Grundbildung erlangt werden. </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div style=" margin-left:25px;">
                                            <ul class="list-style">
                                                <li><i class="fa fa-angle-right"></i> <strong>Maturitätsschulen (Gymnasien)</strong> Um die Matura (Reifeprüfung/Abitur) zu erlangen ist der Besuch einer Maturitätsschule erforderlich. Diese dauert in der Regel 3-4 Jahre. Nach erfolgreicher Absolvierung hat der Maturand die prüfungsfreie Zugangs- und Studienberechtigung für ein Studium an einer Hochschule seiner Wahl.</li>
                                                <li><i class="fa fa-angle-right"></i> <strong>Fachmittelschulen (FMS):</strong> Die Dauer der Ausbildung der Fachmittelschule beträgt 3 Jahre und wird mit der Fachmaturität oder dem Fachmittelschulabschluss (Erstabschluss) abgeschlossen.</li>
                                            </ul>
                                        </div>    
                                    </div>
                                </div>
