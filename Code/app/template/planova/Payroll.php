                    ...
                    <div class="row mt-15">
                        <div class="col-md-12">
                            <div class="box-wrapper page-content">
                                <div class="thumb">
                                    <h3><span>Lohnabrechnung</span></h3>
                                    <hr></hr>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="thumb">
                                                                ...
                                                                foreach ($yearData as $month => $monthData) {
                                                                    foreach ($monthData as $monthKey => $fileData) {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><?php if (preg_match('~MSIE|Internet Explorer~i', $_SERVER['HTTP_USER_AGENT']) || (strpos($_SERVER['HTTP_USER_AGENT'], 'Trident/7.0; rv:11.0') !== false)) { ?>
                                                                                    <a
                                                                                    ...
                                                                                    title="Vertrag <?= $arrFileName[5] ?>: Lohnabrechnung <?= $arrFileName[6] ?> <?= $arrFileName[7] ?>">
                                                                                        Öffnen</a> <?php } else { ?><a
                                                                                    href="<?= WEB_URL ?>/Candidate/viewPayRollFile?fileName=<?= $fileData['filename'] ?>.<?= $fileData['extension'] ?>&keepThis=true&TB_iframe=true&height=800&width=900"
                                                                                    title="Vertrag <?= $arrFileName[5] ?>: Lohnabrechnung <?= $arrFileName[6] ?> <?= $arrFileName[7] ?>"
                                                                                    class="thickbox">
                                                                                        Öffnen</a> <?php } ?>| <a
                                                                                        href="<?= WEB_URL ?>/Candidate/viewPayRollFile?fileName=<?= $fileData['filename'] ?>.<?= $fileData['extension'] ?>&fileDownload=1"
                                                                                        title="Vertrag <?= $arrFileName[5] ?>: Lohnabrechnung <?= $arrFileName[6] ?> <?= $arrFileName[7] ?>">Download</a>
                                                                            </td>
                                                                        </tr>
