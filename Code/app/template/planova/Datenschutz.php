            ...
            <div class="col-md-12">
                <div class="page-content box-wrapper">
                    <section class="page-article-content clearfix">
                        <div class="row">
                            <div class="col-sm-12">
                                <h1 style="margin-top: 0px; margin-bottom: 25px">DATENSCHUTZRICHTLINIE</h1>
...
Wir können die Daten, die Sie uns zur Verfügung gestellt haben, zur Erbringung der von Ihnen angefragten Arbeitsvermittlungs- und/oder Temporärdienste nutzen. Dazu zählt u. a. auch die Überprüfung sowie die Bereitstellung dieser uns zur Verfügung gestellten Daten für potenzielle und tatsächliche Einsatzbetriebe bzw. Arbeitnehmer. Wir verarbeiten einige Ihrer vertraulichen personenbezogenen Daten, wie z.B. Angaben zu Ihrer Nationalität, körperlichen und geistigen Gesundheit sowie über von Ihnen begangene oder mutmasslich begangene Straftaten.
                        ...
                        <div class="row" style="margin-top:25px;">
                            <div class="col-sm-12">
                                ...
                                <p style="text-align: justify">
                                   planova human capital ag erhebt zur ständigen Optimierung des Angebots statistische Daten. So werden beispielsweise Daten gesammelt über die Anzahl geleisteter Arbeitsstunden pro Beruf und Branche, über das Verhältnis der Anzahl geleisteter Arbeitsstunden im Verhältnis zur Anzahl der Arbeitnehmer sowie über die Anzahl nicht ausgeübter Einsätze infolge mangelnder Arbeitnehmer.
                                </p>
                            </div>
                        </div>
                        <div class="row" style="margin-top:25px;">
