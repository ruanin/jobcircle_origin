            ...
            <div class="box-wrapper">
                <div class="single-page-item">
                    <?php if(isset($data['error']['0'])){?>
                        <div id="error" class="alert alert-danger" style="margin-left:7px;margin-right:7px;"><?=$data['error']['0']?></div>
                    <?php } ?>
                    <form id="register-wizard" action="#" class="form-horizontal" method="POST" enctype="multipart/form-data">
